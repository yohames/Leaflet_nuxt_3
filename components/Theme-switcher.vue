    ...
    <ClientOnly>
      ...
      >
        ...
        <HeadlessListboxButton type="template">
          <button
            class="dark:text-gray-400 text-gray-600 flex items-center p-2 hover:bg-gray-200 dark:hover:bg-gray-100/30 rounded-full duration-300"
          >
        ...
        >
          <HeadlessListboxOption
            ...
            :class="{
              ...
              'text-gray-600 dark:text-gray-200 bg-gray-100 dark:bg-gray-600/30':
